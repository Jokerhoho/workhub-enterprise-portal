...
2. Submit `https://jokerhoho.github.io/workhub-enterprise-portal/sitemap.xml`.
...
5. Keep `https://jokerhoho.github.io/workhub-enterprise-portal/` as the only
   canonical origin unless a verified custom domain is configured later.
